...
enum TDiskTypeTag
{
    kDiskTypeExtFlash       = 0,        ///< 磁盘类型-spi_flash
    kDiskTypeUsb,                       ///< 磁盘类型-u盘
    kDiskTypeMax,
};
typedef enum TDiskTypeTag TDiskType;


/*---------------------------------------*/
/* Prototypes for disk control functions */
///< 磁盘驱动创建对象
DSTATUS disk_create(uint8_t pdrv);
///< 磁盘循环执行检查(u盘使用)
void disk_run_once(uint8_t pdrv);
